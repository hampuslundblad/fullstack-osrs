...
sudo certbot certonly  --non-interactive --redirect --webroot --webroot-path /home/hampus/fullstack-osrs -d hampuslundblad.com --agree-tos -m hampus.lundblad@hotmail.se || error_exit "Failed to obtain SSL certificate"
