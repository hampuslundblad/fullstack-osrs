...
sudo certbot certonly --webroot --webroot-path /home/hampus/fullstack-osrs -d hampuslundblad.com --agree-tos -m hampus.lundblad@hotmail.se --noninteractive --redirect || error_exit "Failed to obtain SSL certificate"
